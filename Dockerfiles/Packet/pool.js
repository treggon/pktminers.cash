...
config.masterUrl = 'http://dalpool.pktminers.cash';
...
config.annHandlers = [
    {
        ...
        url: 'http://ann01.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann02.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann03.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann04.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann05.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann06.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann07.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann08.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann09.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann10.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann11.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann12.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann13.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann14.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann15.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann16.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann17.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann18.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann19.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann20.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann21.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann22.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann23.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann24.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann25.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann26.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann27.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann28.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann29.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann30.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann31.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann32.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann33.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann34.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann35.pktminers.cash',
    },
    {
        // What address should be advertized for accessing this ann handler (external address)
        // You will also need to configure the handler itself in packetcrypt_rs
        url: 'http://ann36.pktminers.cash',
    },
];
